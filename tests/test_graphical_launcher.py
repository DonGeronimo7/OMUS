...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("kitty", ["/usr/bin/kitty", "--class", "MouseControl", "--title", "Mouse Control", "/usr/bin/mouse-control"]),
        ("foot", ["/usr/bin/foot", "--app-id=mouse-control", "--title=Mouse Control", "/usr/bin/mouse-control"]),
        ("alacritty", ["/usr/bin/alacritty", "--class", "MouseControl,MouseControl", "--title", "Mouse Control", "-e", "/usr/bin/mouse-control"]),
        ("wezterm", ["/usr/bin/wezterm", "start", "--class", "MouseControl", "--always-new-process", "--", "/usr/bin/mouse-control"]),
        ("gnome-terminal", ["/usr/bin/gnome-terminal", "--title=Mouse Control", "--", "/usr/bin/mouse-control"]),
        ("kgx", ["/usr/bin/kgx", "--title=Mouse Control", "--", "/usr/bin/mouse-control"]),
        ("konsole", ["/usr/bin/konsole", "--new-tab", "-p", "tabtitle=Mouse Control", "-e", "/usr/bin/mouse-control"]),
        ("xfce4-terminal", ["/usr/bin/xfce4-terminal", "--title=Mouse Control", "--execute", "/usr/bin/mouse-control"]),
        ("mate-terminal", ["/usr/bin/mate-terminal", "--title=Mouse Control", "--", "/usr/bin/mouse-control"]),
        ("xterm", ["/usr/bin/xterm", "-T", "Mouse Control", "-e", "/usr/bin/mouse-control"]),
    ],
)
