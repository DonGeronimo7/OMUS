...
def read_backend_teacher_state(
    ...
    *,
    ...
    """Compatibility bridge returning semantic labels only.

    Existing guided-learning callers consume a mapping. The richer
    :func:`read_teacher_state` API preserves trust/provenance for new code while
    this function intentionally strips everything except semantic answer keys.
    """
