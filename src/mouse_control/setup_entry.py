...
from .setup_tui_integrated import run_integrated_setup_tui
...
def run_tui_setup_wizard() -> int:
    """Run setup through the integrated TUI while preserving commit/rollback."""
    ...
    try:
        ...
        result = run_integrated_setup_tui(
            mice,
            existing_config,
