...
def render_report(report: dict[str, Any]) -> str:
    titles = (("mouse_control", "Mouse Control"), ("system", "System"), ("device", "Device"), ("interfaces", "Interfaces"), ("input", "Input Capabilities"), ("hid", "HID"), ("backend", "Backend"), ("guided", "Guided Tests"))
    lines = ["Mouse Control Hardware Support Report", "", "Generated by mouse-control. This report is intended to be safe to share publicly.", "It contains only selected-mouse and basic system compatibility information.", ""]
