...
[![Current release: v0.9.6-2](https://img.shields.io/badge/release-v0.9.6--2-2ea44f)](https://github.com/DonGeronimo7/mouse-control/releases/tag/v0.9.6-2)
...
The current release is [v0.9.6-2](https://github.com/DonGeronimo7/mouse-control/releases/tag/v0.9.6-2).

## Install and run

Download the package for your system from the
[v0.9.6-2 release](https://github.com/DonGeronimo7/mouse-control/releases/tag/v0.9.6-2),
then install it as shown below.

### Fedora, Nobara, and other RPM systems

[Download the RPM](https://github.com/DonGeronimo7/mouse-control/releases/download/v0.9.6-2/mouse-control-0.9.6-2.fc44.noarch.rpm), then run:

```bash
sudo dnf install ./mouse-control-0.9.6-2.fc44.noarch.rpm
```

### Debian, Ubuntu, Mint, and other DEB systems

[Download the DEB](https://github.com/DonGeronimo7/mouse-control/releases/download/v0.9.6-2/mouse-control_0.9.6-2_all.deb), then run:

```bash
sudo apt install ./mouse-control_0.9.6-2_all.deb
```

### Other x86-64 Linux distributions

[Download the AppImage](https://github.com/DonGeronimo7/mouse-control/releases/download/v0.9.6-2/Mouse-Control-0.9.6-2-x86_64.AppImage), then run:

```bash
chmod +x Mouse-Control-0.9.6-2-x86_64.AppImage
./Mouse-Control-0.9.6-2-x86_64.AppImage setup
```
...
[Python wheel](https://github.com/DonGeronimo7/mouse-control/releases/download/v0.9.6-2/mouse_control-0.9.6.post2-py3-none-any.whl),
and [source archive](https://github.com/DonGeronimo7/mouse-control/releases/download/v0.9.6-2/mouse_control-0.9.6.post2.tar.gz)
are also published.
