...
[![Current release: v1.0.3](https://img.shields.io/badge/release-v1.0.3-6f42c1)](https://github.com/DonGeronimo7/OMUS/releases/tag/v1.0.3)
...
The current release is [v1.0.3](https://github.com/DonGeronimo7/OMUS/releases/tag/v1.0.3).

## Install and run

Download the package for your system from the
[v1.0.3 release](https://github.com/DonGeronimo7/OMUS/releases/tag/v1.0.3),
then install it as shown below.

### Fedora, Nobara, and other RPM systems

[Download the RPM](https://github.com/DonGeronimo7/OMUS/releases/download/v1.0.3/omus-1.0.3-1.fc44.noarch.rpm), then run:

```bash
sudo dnf install ./omus-1.0.3-1.fc44.noarch.rpm
```

### Debian, Ubuntu, Mint, and other DEB systems

[Download the DEB](https://github.com/DonGeronimo7/OMUS/releases/download/v1.0.3/omus_1.0.3_all.deb), then run:

```bash
sudo apt install ./omus_1.0.3_all.deb
```

### Other x86-64 Linux distributions

[Download the AppImage](https://github.com/DonGeronimo7/OMUS/releases/download/v1.0.3/OMUS-1.0.3-x86_64.AppImage), then run:

```bash
chmod +x OMUS-1.0.3-x86_64.AppImage
./OMUS-1.0.3-x86_64.AppImage setup
```
...
[Python wheel](https://github.com/DonGeronimo7/OMUS/releases/download/v1.0.3/omus-1.0.3-py3-none-any.whl),
and [source archive](https://github.com/DonGeronimo7/OMUS/releases/download/v1.0.3/omus-1.0.3.tar.gz)
are also published.
